...
const content: Record<Locale, SectionCopy> = {
  ru: {
    ...
    text: "Опишите задачу — перезвоним и уточним детали. Если есть фото объекта, приложите.",
    nameLabel: "Имя",
    ...
    filesHint: "Фото щита, схемы, планы. PDF, Word, Excel, PNG, JPG.",
    filesDragHint: "Перетащите сюда или выберите.",
  ...
  hy: {
    ...
    text: "Նկարագրեք խնդիրը՝ կզանգահարենք և կճշտենք մանրամասները։ Եթե կա օբյեկտի լուսանկար՝ կցեք։",
    nameLabel: "Անուն",
    ...
    filesLabel: "Ֆայլեր",
    filesButton: "Կցել",
    filesHint: "Վահանի լուսանկարներ, սխեմաներ, պլաններ։ PDF, Word, Excel, PNG, JPG։",
    filesDragHint: "Քաշեք այստեղ կամ ընտրեք։",
