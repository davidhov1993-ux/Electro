...
const installationPageCopy: Record<Locale, InstallationPageLocaleCopy> = {
  ru: {
    ...
    summary:
      "Монтаж электрики для квартиры, дома, офиса и коммерческого помещения. Линии, группы, щит, точки подключения и нормальная база под реальную нагрузку.",
    ...
    logicLabel: "Инженерная база",
    logicTitle: "Что важно предусмотреть заранее",
    logicItems: [
      "понятное деление по группам",
      "нормальный запас по нагрузке",
      "правильную защиту линий",
      "доступ к щиту и обслуживаемым узлам",
      "резерв под технику, свет и будущие сценарии",
      "аккуратную трассировку без хаоса и временных решений",
    ],
    footerLabel: "Старт работ",
    footerTitle: "Электромонтаж лучше собирать один раз и без переделок.",
    footerMeta: "Электромонтаж в Ереване",
  },
  hy: {
    eyebrow: "Գծեր, խմբեր, միացում",
    summary:
      "Էլեկտրամոնտաժ բնակարանի, տան, գրասենյակի և կոմերցիոն տարածքի համար։ Գծեր, խմբեր, վահան, միացման կետեր և նորմալ հիմք իրական ծանրաբեռնվածության համար։",
    request: "Թողնել հայտ",
    whatsapp: "WhatsApp",
    ...
    logicLabel: "Ինժեներական հիմք",
    logicTitle: "Ինչը պետք է ճիշտ դնել սկզբից",
    logicItems: [
      "հասկանալի բաժանում խմբերով",
      "ծանրաբեռնվածության նորմալ պաշար",
      "գծերի ճիշտ պաշտպանություն",
      "մուտք վահանին և սպասարկվող հանգույցներին",
      "պահուստ տեխնիկայի, լույսի և ապագա սցենարների համար",
      "կոկիկ գծանշում առանց քաոսի և ժամանակավոր լուծումների",
    ],
    footerLabel: "Աշխատանքի մեկնարկ",
    footerTitle: "Էլեկտրամոնտաժը ճիշտ է հավաքել մեկ անգամ և առանց հետագա վերամշակման։",
